...
function PlioIn resetStim();
    return PlioIn {
        ...
        adValid: False, ad: 0, parValid: False, par: 0,
...
function PlioIn stimulus(Bit#(8) cycle);
    case (cycle)
        ...
        13: return workerStim(32'h0000_0100, True, 4'hf, True, PlioWorker, BurstOne, True, False, 0);
...
function Action emitTrace(Bit#(8) cycle, PlioIn pi, PlioOut po, QliOut qo, String ev);
    action
        $display(
            ...
            pack(qo.dmaCompletionValid), zeroExtend(pack(qo.dmaCompletion.status)),
