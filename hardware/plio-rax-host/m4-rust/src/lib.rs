...
impl PLIOHostCore {
    ...
    pub fn step(&mut self,input:CoreInput)->CoreOutput{
        ...
        if input.reset{
            ...
            self.role=CoreRole::Idle;self.active_slot=None;self.queued_worker=None;self.cursor=0;self.wait_cycles=0;self.dma_direction=None;self.dma_address_pending=None;self.write_ack_pending=false;self.last_fault=None;
